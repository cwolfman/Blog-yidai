...
public class BlogServiceImpl implements BlogService {
    ...
    @Override
    public int saveViews(int views, Long id) {
        return blogDao.saveViews(views, id);
    }
